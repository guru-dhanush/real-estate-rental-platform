...
>(({ className, placeholder, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      "flex h-11 w-full items-center justify-between whitespace-nowrap rounded-lg border border-gray-300 bg-white px-4 py-2.5 text-sm shadow-theme-xs",
...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item
    ...
    className={cn(
      ...
      "text-gray-700 focus:bg-gray-100 data-[disabled]:pointer-events-none data-[disabled]:opacity-50",
      "dark:text-gray-400 dark:focus:bg-gray-800",
      className
    )}
    {...props}
  >
