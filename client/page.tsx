...
const NewProperty = () => {
  ...
  useEffect(() => {
    if (!showLegacyFields) {
      form.setValue("beds", 0);
      form.setValue("baths", 0);
      form.setValue("isPetsAllowed", false);
      form.setValue("isParkingIncluded", false);
    }
  }, [selectedPropertyType, form, showLegacyFields]);
